...
import json
from pyanalysis.settings.common import TWITTER_ACCESS_TOKEN, TWITTER_ACCESS_TOKEN_SECRET, DEBUG
import re
import os
import os.path
...
def get_embedded_html(tweet_original_id):
    ...
    if DEBUG or os.environ["DJANGO_SETTINGS_MODULE"] == "pyanalysis.settings.test":
